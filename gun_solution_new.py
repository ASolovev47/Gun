...
gun2 = Gun(screen,x=40, side=1)
trg = [Target(screen) for i in range(0,40)] #создание элементов
...
while not finished:
    ...
    score_text = font.render("Очки малые: " + str(POINT), True, WHITE)
    screen.blit(score_text, (10, 10))
    score_text1 = font.render("Очки большие: " + str(POINT1), True, WHITE)
    screen.blit(score_text1, (10, 100))
    ...
    if not trg:
        trg = [Target(screen) for i in range(0,20)] 
